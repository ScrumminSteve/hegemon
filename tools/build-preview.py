...
FILES = [
  'src/data/map.js', 'src/data/factions.js', 'src/data/setup.js',
    'src/data/leaderCards.js', 'src/data/eventCards.js', 'src/data/invaderCards.js',
    'src/data/registry.js',
  'src/themes/core.js', 'src/themes/warroses.js', 'src/themes/modern2026.js',
  ...
  'src/engine/legal.js', 'src/agents/random.js',
  'src/data/edgeRoutes.js', 'src/icons.js', 'src/map-view.js', 'src/game/app.js',
]
