...
<symbol id="i-coin" viewBox="0 0 24 24"><path d="M4 19.5 C4 13 6.5 9.8 10.5 9.8 C12.6 9.8 14.1 11 14.8 12.8 L14.8 8.2 C14.8 6 16 4.6 17.6 4.6 C19.3 4.6 20.5 5.9 20.5 7.6 L20.5 19.5 Z" fill="currentColor" stroke="var(--ink)" stroke-width="1.1" stroke-linejoin="round"/></symbol>`,
  ...
  modern2026: {
    token: 'square',
    defs: `${ORD_SHARED}
<symbol id="i-unit-infantry" viewBox="0 0 24 24"><path d="M2.5 15.2 L14.5 15.2 L14.5 13.2 L21.5 13.2 L21.5 14.6 L16 14.6 L16 15.9 L18.6 15.9 L18.6 17.2 L12.6 17.2 L12.6 15.9 L11 15.9 L9.6 19 L7.6 19 L9 15.9 L5.8 15.9 L4.6 18 L2.8 18 L4 15.9 L2.5 15.9 Z" fill="currentColor" stroke="var(--ink)" stroke-width="0.8" stroke-linejoin="round"/></symbol>
