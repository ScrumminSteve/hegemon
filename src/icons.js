...
<symbol id="i-unit-siege_engine" viewBox="0 0 24 24"><path d="M5 20.5 L10.5 8.5 L16 20.5" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"/><path d="M7.2 12.8 L20.4 4.8" stroke="currentColor" stroke-width="3" stroke-linecap="round"/><circle cx="20" cy="5.2" r="3" fill="currentColor" stroke="var(--ink)" stroke-width="1.1"/><path d="M3.5 20.5 H17.5" stroke="currentColor" stroke-width="3" stroke-linecap="round"/></symbol>
...
<symbol id="i-coin" viewBox="0 0 24 24"><path d="M4 19.5 C4 13 6.5 9.8 10.5 9.8 C12.6 9.8 14.1 11 14.8 12.8 L14.8 8.2 C14.8 6 16 4.6 17.6 4.6 C19.3 4.6 20.5 5.9 20.5 7.6 L20.5 19.5 Z" fill="currentColor" stroke="var(--ink)" stroke-width="1.1" stroke-linejoin="round"/></symbol>`,
  ...
  modern2026: {
    token: 'square',
    defs: `${ORD_SHARED}
<symbol id="i-unit-infantry" viewBox="0 0 24 24"><circle cx="12" cy="5.2" r="2.6" fill="currentColor" stroke="var(--ink)" stroke-width="0.9"/><path d="M8.6 9.2 L15.4 9.2 L16.6 14.8 L14.8 14.8 L14.2 11.8 L14.2 21 L12.6 21 L12.6 15.4 L11.4 15.4 L11.4 21 L9.8 21 L9.8 11.8 L9.2 14.8 L7.4 14.8 Z" fill="currentColor" stroke="var(--ink)" stroke-width="0.9" stroke-linejoin="round"/><path d="M15.4 9.6 L19.5 7.2 L20.1 8.3 L16.2 10.7 Z" fill="currentColor" stroke="var(--ink)" stroke-width="0.7"/></symbol>
<symbol id="i-unit-cavalry" viewBox="0 0 24 24"><rect x="3" y="11.5" width="17" height="6" rx="3" fill="currentColor" stroke="var(--ink)" stroke-width="1"/><rect x="8" y="7.8" width="7.4" height="4.4" rx="1.2" fill="currentColor" stroke="var(--ink)" stroke-width="1"/><rect x="15" y="9.1" width="7" height="1.9" fill="currentColor" stroke="var(--ink)" stroke-width="0.7"/><circle cx="7" cy="15.5" r="1.1" fill="var(--ink)"/><circle cx="11.5" cy="15.5" r="1.1" fill="var(--ink)"/><circle cx="16" cy="15.5" r="1.1" fill="var(--ink)"/></symbol>
...
<symbol id="i-unit-siege_engine" viewBox="0 0 24 24"><path d="M12 2.5 L15 8 L15 16 L9 16 L9 8 Z" fill="currentColor" stroke="var(--ink)" stroke-width="1" stroke-linejoin="round"/><path d="M9 13.5 L5.8 17.5 L9 16.5 M15 13.5 L18.2 17.5 L15 16.5" fill="currentColor" stroke="var(--ink)" stroke-width="0.9"/><path d="M10.4 16.5 L12 21 L13.6 16.5" fill="none" stroke="var(--ink)" stroke-width="1.6" stroke-linecap="round"/></symbol>
